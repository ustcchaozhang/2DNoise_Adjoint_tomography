...
! FFT parameters
integer, parameter :: LNPT=15, NPT=2**LNPT
...
real(kind=CUSTOM_REAL), parameter :: WTR=0.02
...
! ncyle in window 
! integer, parameter :: ncycle_in_window=1.5
integer, parameter :: ncycle_in_window=3
! normalize
logical :: NORMALIZE=.false.
! error estimation 
logical :: USE_ERROR_CC=.true.
real(kind=CUSTOM_REAL), parameter :: CC_MIN=0.75
real(kind=CUSTOM_REAL), parameter :: TSHIFT_MIN=4.0
