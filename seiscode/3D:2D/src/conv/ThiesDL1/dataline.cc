/*! \file dataline.cc
 * \brief class to represent one data line (implementation)
 * 
 * ----------------------------------------------------------------------------
 * 
 * $Id$
 ...
 * \date 25/11/2008
 * 
 * class to represent one data line (implementation)
 * 
...
#define DL1_dlassert( C, M, L ) \
  if (!(C)) { throw( dl1::ExceptionInconsistentLine( M , __FILE__, \
                                                     __LINE__, #C, L )); }
