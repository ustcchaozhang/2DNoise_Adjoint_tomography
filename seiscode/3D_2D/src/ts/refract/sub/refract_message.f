c this is <refract_message.f>
c------------------------------------------------------------------------------
c
c 04/07/98 by Thomas Forbriger (IfG Stuttgart)
c
c display or remove message
c
c ----
...
c==============================================================================
c
      subroutine refract_message(display, message, position)
c
...
c 
      ...
      elseif (position.eq.'b') then
        ...
        stop 'ERROR (refract_message): called for unknown position'
      endif
c 
      call pgsave
...
c----------------------------------------------------------------------
c
      subroutine refract_warning(message)
c
